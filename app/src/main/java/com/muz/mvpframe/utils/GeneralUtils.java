package com.muz.mvpframe.utils;
...
/***************************************************************************/
    /**
     * 显示网络默认头像
     * @param defaultImg     加载成功前显示的图片
     * @param errorImg       异常时候显示的图片
     * @param nullImg
     * @return
     */
    public static RequestOptions setUrlImgErr(int defaultImg,int errorImg,int nullImg){
     ...
     * @return
     */
    public static RequestOptions setUrlImgErr(int defaultImg){
        return new RequestOptions()
                .placeholder(defaultImg)
                .error(defaultImg)
                .fallback(defaultImg);
    ...
    public static void setText(String data, TextView view) {
        view.setText(TextUtils.isEmpty(data) ? "" : data);//显示内容
    }
        /**
         * 显示内容
         * @param data        内容
         * @param view        控件
         */
    public static void setText(String data, TextView view, String defaultData) {
        view.setText(TextUtils.isEmpty(data) ? defaultData : data);//显示内容
    }
